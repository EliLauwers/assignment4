...
3. Do you need to visit node (1234)? No, because node (123) did not produce anything new Do you need to visit node (124)? Yes, as node (12) produced some new nodes.

```{bash}
java -jar rulebox.jar reason fcf --c edit_rules.rbx --of edit_rules_sufficient.rbx
```

list of rules in sufficient set but not in epsilon
